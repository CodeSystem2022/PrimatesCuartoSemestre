...
public class EstudiantesApplication implements CommandLineRunner {
	...
	private boolean ejecutarOpciones(Scanner consola){
		...
		switch (opcion){
			...
			List<Estudiantes22> estudiantes = estudianteServicio.listarEstudiantes();
			estudiantes.forEach((estudiante -> logger.info(estudiante.toString()+nl)));
			}
			case 2 -> {//Buscar estudiante por id
				logger.info("Digite el id estudiante a buscar: ");
				var idEstudiante = Integer.parseInt(consola.nextLine());
				Estudiantes22 estudiante =
			...
			case 3 -> {//Agregar estudiante
				...
				var estudiante = new Estudiantes22();
			...
			case 5 -> { //Eliminar estudiante
				...
				if(estudiante != null){
					...
					logger.info("Estudiante NO encontrado en id: "+estudiante+nl);
